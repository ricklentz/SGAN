...
prob_gen0, recon_z0 = LL.get_output([disc0_layer_adv, disc0_layer_z_recon], gen_x, deterministic=False)
...
recon_fc3 = LL.get_output(enc_layer_fc3, gen_x) # reconstructed fc3 activations
...
for epoch in range(args.num_epoch):
    ...
    for t in range(nr_batches_train):
        ...
        ''' train generators '''
        l_gen1_adv, l_gen1_cond, l_gen1_ent, l_gen0_adv, l_gen0_cond, l_gen0_ent = train_batch_gen(batchx, batchy_1hot, args.gen_lr)
